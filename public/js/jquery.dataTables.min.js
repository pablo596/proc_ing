...
(function(f) {
    ...
    function ob(a) {
        ...
        for (b = k.length; l < b; l++) {
            ...
            h && p.appendTo(c);
            a.oFeatures.bSort &&
                (p.addClass(m.sSortingClass), !1 !== m.bSortable &&
                    (p
            ...
            for (d = h.length; l < d; l++) {
                ...
                for (b = h[l].length; e < b; e++) {
                    ...
                    if (g[l][e] === n) {
                        ...
                        for (
                            g[l][e] = 1; h[l + k] !== n && h[l][e].cell == h[l + k][e].cell;
    ...
    function rb(a) {
        ...
        for (
            var h = a.sDom.split(""), g, k, l, m, p, n, u = 0; u < h.length; u++
        ) {
            g = null;
            k = h[u];
            if ("<" == k) {
    ...
    var db = function(a, b, c, d, e) {
        ...
        eb = function(a) {
            ...
            return f.extend({ search: "none", order: "current", page: "all" },
                a
            );
        },
        fb = function(a) {
